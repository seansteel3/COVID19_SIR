...
NYR0.mlT #3.370366[ 3.272212 , 3.470433 ]
...
#Large discrepancy between various R0 estimation methods implies data issues or other estimation problems (assumptions not met, incorrect underlying distribution, etc...)
...
### Negative Binomia Distrobution ### -- Likely most "accurate" distrobution sicne we drop the poisson assumtion that mean = st.dev
```{r}
